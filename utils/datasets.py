            ...
            try:
                ...
                if os.path.isfile(lb_file):
                    ...
                    if len(l):
                        ...
                        if kpt_label:
                            assert l.shape[1] == 14, "labels require 14 columns each"
                            ...
                            assert (
                                l.shape[1] == 11
                            ), "labels require 11 columns each after removing occlusion paramater"
                        else:
    ...
    if n:
        ...
        if use_segments:  # warp segments
            ...
            if kpt_label:
                ...
                ).reshape(n, 6)  # perspective rescale or affine
                xy_kpts[targets[:,5:]==0] = 0
                x_kpts = xy_kpts[:, list(range(0, 6, 2))]
                y_kpts = xy_kpts[:, list(range(1, 6, 2))]
                ...
                xy_kpts[:, list(range(0, 6, 2))] = x_kpts
                xy_kpts[:, list(range(1, 6, 2))] = y_kpts
